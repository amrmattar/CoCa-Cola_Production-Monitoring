...
@Component({
  selector: 'app-resource-material-time-line',
  templateUrl: './resource-material-time-line.component.html',
  styleUrls: ['./resource-material-time-line.component.scss'],
})
export class ResourceMaterialTimeLineComponent implements OnInit {
  asd: string = '';
  email: string;
  newPassord: string;
  roleName;
  ...
  onUsersEdit(evt) {
    ...
    if (evt.requestType == 'save' && this.emailFlag != 'beginEdit') {
      ...
      this.apiService.putMaterials(newuser).subscribe((x) => {});
      setTimeout(() => {
        debugger;
        this.apiService.getMaterials().subscribe((Materials) => {
          this.Materials = Materials;
      ...
      this.apiService.putEditMaterials(edituser).subscribe((x) => {});
      setTimeout(() => {
        this.apiService.getMaterials().subscribe((Materials) => {
          this.Materials = Materials;
        });
