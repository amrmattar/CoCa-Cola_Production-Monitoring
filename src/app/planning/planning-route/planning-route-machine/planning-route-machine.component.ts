...
@Component({
  selector: 'app-planning-route-machine',
  templateUrl: './planning-route-machine.component.html',
  styleUrls: ['./planning-route-machine.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PlanningRouteMachineComponent implements OnInit {
  ...
  //     .getMachinesList()
  //     .subscribe((res) => {
  //       const data = JSON.parse(JSON.stringify(res)).reads;
