...
@Component({
  selector: 'app-usage-ratio-top',
  templateUrl: './usage-ratio-top.component.html',
  styleUrls: ['./usage-ratio-top.component.scss'],
  providers: [SelectionService, EditService, PageService, CommandColumnService],
})
export class UsageRatioTopComponent implements OnInit {
  public data: Object[];
