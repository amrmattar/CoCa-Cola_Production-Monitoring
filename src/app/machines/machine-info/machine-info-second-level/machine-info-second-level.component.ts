...
@Component({
  selector: 'app-machine-info-second-level',
  templateUrl: './machine-info-second-level.component.html',
  styleUrls: ['./machine-info-second-level.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class MachineInfoSecondLevelComponent implements OnInit {
